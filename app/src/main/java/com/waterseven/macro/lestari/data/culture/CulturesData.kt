...
object CulturesData {
    val dummyCultures = listOf(
        Culture(
            ...
            title = "Rumah Joglo",
            place = "Jawa",
            description = "Rumah Joglo adalah gaya bangunan (terutama untuk tempat tinggal) khas Jawa, atapnya menyerupai trapesium, di bagian tengah menjulang ke atas berbentuk limas, serambi depan lebar dan ruang tengah tidak bersekat-sekat (biasanya dipergunakan sebagai ruang tamu).",
            imageCover = "https://pariwisataindonesia.id/wp-content/uploads/2020/05/Rumah-Adat-Joglo-kompasiana.com_.jpg",
            imageAsset = listOf(),
            video = ""
        ),
        Culture(
        ...
        Culture(
            ...
            place = "Bengkulu",
            description = "Rumah Bubungan Lima adalah rumah adat dari provinsi Bengkulu. Rumah ini memiliki model seperti rumah panggung yang ditopang oleh beberapa tiang penopang. Rumah ini bukanlah rumah tinggal seperti pada umumnya. Biasanya rumah ini digunakan untuk acara adat masyarakat Bengkulu.\n" +
                    "Rumah ini terbagi atas tiga bagian yaitu rumah bagian atas, rumah bagian tengah, dan rumah bagian bawah.[1] Rumah Bubungan Lima memiliki materi dasar yaitu kayu.[1] Kayu yang dipilih pun bukan kayu sembarangan melainkan kayu yang kuat dan tahan lama. Kayu yang biasanya digunakan untuk membangun Rumah Bubungan Lima adalah Kayu Medang Kemuning. Rumah Bubungan Lima dibangun tinggi agar menghindari pemilik rumah beserta keluarga dari serangan binatang liar dan juga dari bencana alam seperti banjir. Karena tinggi Rumah Bubungan Lima ini, maka orang-orang yang hendak masuk ke dalam rumah pun harus menggunakan tangga. Tangga yang digunakan untuk masuk ke dalam rumah umumnya mempunyai jumlah anak tangga yang ganjil sesuai dengan kepercayaan masyarakat Bengkulu. Rumah Bubungan Lima ini merupakan salah satu Budaya Indonesia yang menjadi objek wisata. Pada zaman dahulu rumah bubungan lima menjadi tempat tinggal para raja ataupun kaum bangsawan.",
            imageCover = "https://img.iproperty.com.my/angel-legacy/1110x624-crop/static/2021/08/Mengenal-Rumah-Adat-Bengkulu-Bubungan-Lima-dan-Filosofinya.png",
            imageAsset = listOf(),
            video = ""
        )
    )
